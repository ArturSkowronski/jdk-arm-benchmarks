...
# Script to automate creation of a Google Axion (Arm-based) VM instance using gcloud CLI.
# Usage:
#   ./create_axion_instance.sh <PROJECT_ID> <ZONE> [NETWORK] [SUBNET]
#
# Example:
#   ./create_axion_instance.sh my-gcp-project us-central1-a
#   ./create_axion_instance.sh my-gcp-project us-central1-a my-network my-subnet
...
NETWORK="$3"
SUBNET="$4"
INSTANCE_NAME="test-app-instance"
...
echo "Creating Axion VM instance: $INSTANCE_NAME"
eval $CREATE_CMD
